class TimeMap:
    ...
    def set(self, key: str, value: str, timestamp: int) -> None:
        ...
        to_insert = self.binary_search_right(value_list, timestamp)
        value_list.insert(to_insert, (value, timestamp))
        self.value_dict[key] = value_list


    def binary_search_right(self, values, timestamp):
        """
            return the index so that values[index:] >= timestamp
        """
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        low = self.binary_search_right(values, timestamp)
